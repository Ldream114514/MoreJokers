...
SMODS.Joker {
    ...
    cost = 6,
    pos = { x = 1, y = 3 },
    config = { extra = { odds = 100, d_size = 2, hands = 2 } },
...
SMODS.Joker {
    ...
    calculate = function(self, card, context)
    if context.using_consumeable and not context.blueprint and context.consumeable.ability.set == "Tarot" and #G.consumeables.cards + G.GAME.consumeable_buffer < G.consumeables.config.card_limit then
